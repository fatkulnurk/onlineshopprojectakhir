...
class CI_Email {
	...
	var	$smtp_host		= "server250.web-hosting.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "bos@dibumi.com";		// SMTP Username
	var	$smtp_pass		= "bos@dibumi.com";		// SMTP Password
