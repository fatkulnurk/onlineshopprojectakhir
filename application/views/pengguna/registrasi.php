...
<tr><td valign='top' align='right'>Nama awal &nbsp; &nbsp; &nbsp;</td><td>
		<?php 	echo form_input('nama_awal',set_value('nama_awal'),'class=inputan');
...
<tr><td valign='top' align='right'>Nama Akhir &nbsp; &nbsp; &nbsp;</td><td>
		<?php 	echo form_input('nama_akhir',set_value('nama_akhir'),'class=inputan');?></td><td></td></tr>
<tr><td valign='top' align='right'>Email &nbsp; &nbsp; &nbsp;</td><td>
		<?php echo form_input('email',set_value('email'),'class=inputan'); ?>				
...
<tr><td valign='top' align='right'>Kata Sandi &nbsp; &nbsp; &nbsp; </td><td>
		<?php echo form_password('password',set_value('password'),'class=inputan'); ?>
...
<tr><td valign='top' align='right'>Ketik ulang kata sandi &nbsp; &nbsp; &nbsp;</td><td>
		 <?php echo  form_password('konfirmasi_password',set_value('konfirmasi_password'),'class=inputan'); ?>
...
<tr><td  ><font color='red' size='1px'>* Wajib diisi</font></td><td>
		<?php $kirim=array('name'=>'submit', 
						   'value'=>'Kirim', 
						   'class'=>'tmbl');		echo form_submit($kirim); ?> </td></tr>
</table>
<?php form_close(); ?>
