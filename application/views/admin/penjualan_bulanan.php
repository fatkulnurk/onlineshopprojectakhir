...
<div class="Ket"><table width="100%" class="table"><tr>
	...
	<?php echo "<a href='".base_url()."admin/penjualan_harian'>". form_button('Insert','Transaksi Harian','class=tmbl-oren')."</a>"; ?>
	<?php echo "<a href='".base_url()."admin/penjualan_tahunan'>". form_button('Insert','Transaksi Tahunan','class=tmbl-oren')."</a>"; ?></td></tr>
	</table>
</div><center>
<?php $options = array('01'=>'Januari','02'=>'Februari','03'=>'Maret','04'=>'April','05'=>'Mei','06'=>'Juni','07'=>'Juli',
					'08'=>'Agustus','09'=>'September','10'=>'Oktober','11'=>'November','12'=>'Desember'
                ); echo "Bulan ".form_dropdown('bulan', $options,'','class=in');
for($k=2011; $k<=date('Y'); $k++){
